...
(function () {
  ...
  KLH.layanan = {
    ...
    'pengaduan-aspirasi': {
      ...
      services: [
        { name: 'Pengaduan Lingkungan KLH (e-Gakkum)', icon: 'external', desc: 'Formulir pengaduan resmi kementerian untuk dugaan pencemaran dan/atau kerusakan lingkungan. Dapat dilampiri foto/video.', href: 'https://egakkum.kemenlh.go.id/', ext: true },
    ...
    'regulasi-pembelajaran': {
      ...
      services: [
        { name: 'Peraturan Lingkungan Hidup (JDIH)', icon: 'external', desc: 'Jaringan Dokumentasi dan Informasi Hukum: UU, PP, Peraturan Menteri, dan SK dalam satu pencarian.', href: 'https://jdih.kemenlh.go.id', ext: true },
