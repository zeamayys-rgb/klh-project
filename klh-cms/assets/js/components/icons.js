...
(function () {
  ...
  var P = {
    ...
    image: '<rect x="3.5" y="5" width="17" height="14" rx="2"/><circle cx="8.8" cy="9.8" r="1.5"/><path d="M5 16.5L9.5 12l3 3 3-3.5 4 4.5"/>',
    eyeoff: '<path d="M4.5 4.5l15 15"/><path d="M9.9 6.2A9 9 0 0112 5.8c6 0 9.5 6.2 9.5 6.2a17.6 17.6 0 01-3.3 3.8M6.3 8.2A16.6 16.6 0 002.5 12S6 18.2 12 18.2c1 0 2-.2 2.9-.5"/><path d="M9.7 10.5a2.8 2.8 0 003.8 3.9"/>',
    ...
    /* ---- Tambahan Modul 03 · Omni Channel ---- */
    ticket: '<path d="M4 7.5h16v3.2a1.8 1.8 0 000 3.6v3.2H4v-3.2a1.8 1.8 0 000-3.6z"/><path d="M14.5 7.5v1.6M14.5 11.2v1.6M14.5 14.9v1.6"/>',
    send: '<path d="M20.5 3.5l-17 6.5 6.2 2.3 2.3 6.2z"/><path d="M20.5 3.5L9.7 12.3"/>',
    reply: '<path d="M9.5 7L4 12l5.5 5"/><path d="M4 12h9.5a6.5 6.5 0 016.5 6.5V19"/>',
    escalate: '<path d="M4 17l5-5 3.5 3L20 7.5"/><path d="M14.5 7.5H20V13"/>',
    route: '<path d="M4 7h4.5L15 17h5M15 7h5M4 17h4.5"/><path d="M17.5 4.5L20.5 7l-3 2.5M17.5 14.5l3 2.5-3 2.5"/>',
    logout: '<path d="M14.5 4H5v16h9.5"/><path d="M10 12h10.5M17 8l3.5 4-3.5 4"/>',
    key: '<circle cx="8" cy="15.5" r="4"/><path d="M11 12.5l9-9M16 7.5l3 3M13.5 10l2.5 2.5"/>',
    history: '<path d="M4.5 5v4h4"/><path d="M5 9a8.3 8.3 0 11-.6 4"/><path d="M12 8v4.5l3 1.8"/>',
    ...
    chwa: '<path d="M12 4a8 8 0 00-6.9 12l-1 4 4.1-1A8 8 0 1012 4z"/><path d="M9.2 9.2c.5 2.8 2.8 5.1 5.6 5.6"/>',
    chig: '<rect x="4" y="4" width="16" height="16" rx="4.5"/><circle cx="12" cy="12" r="3.6"/><path d="M16.8 7.2h.01"/>',
    chfb: '<path d="M13.5 20.5v-7.2h2.7l.5-3.1h-3.2V8.3c0-1 .4-1.8 1.9-1.8h1.5v-3s-1-.2-2.2-.2c-2.6 0-4.3 1.6-4.3 4.4v2.5H7.8v3.1h2.6v7.2"/>',
    chx: '<path d="M5 4h3.6L19 20h-3.6z"/><path d="M19 4l-6.2 7M11.2 13L5 20"/>'
  };
